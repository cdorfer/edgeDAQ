...
class Axis(object):
	...
	def query(self, string, check_error=False):
		...
		:rtype: string
		"""
		#print string, self.axis, check_error
	...
	def move_to_hardware_limit(self, direction, wait=False):
		"""Move to hardware limit.
		
		:param direction: negative or positive, indicate which direction to move towards.
